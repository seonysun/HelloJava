...
public class String배열_노래 {
	...
	public static void main(String[] args) {
        ...
        int totalpage = (int)(Math.ceil(title.length/10.0));
        							//올림 : ex. ceil(24/10.0)=3
        	//배열의 자료들을 한 페이지에 10개씩 나열했을 때 총 20페이지
        ...
        int j=0; //10개씩 나눠주기 위해 사용하는 변수
        int rowSize=10; //한 페이지에 출력하는 배열요소 수
        int pagecnt = rowSize*(curpage-1);
        	//각 페이지에서 인덱스의 시작 위치 -> 한 페이지에 10개씩(1page:'0'~9, 2page:'10'~19..)
        for(int i=0;i<title.length;i++) {
        	if(j<rowSize && i>=pagecnt) {
        		System.out.println((i+1)+"."+title[i]+"-----"+singer[i]+"["+album[i]+"]");
        		j++; //인덱스 번호 pagecnt부터 시작, rowSize개 만큼 출력하고 종료
        	}
        }
